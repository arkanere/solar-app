<script>
	...
	function applyFilters() {
		...
		window.location.href = '/business-onboarding/find-businesses/in' + (query ? '?' + query : '');
	}

	function clearFilters() {
		window.location.href = '/business-onboarding/find-businesses/in';
	}
	...
	function goToPage(p) {
		...
		if (filters.emailStatus !== 'all') params.set('email_status', filters.emailStatus);
		params.set('page', p);
		window.location.href = '/business-onboarding/find-businesses/in?' + params.toString();
	}
