<script>
	...
	function editBusiness(businessId) {
		// Navigate to the edit page for the business with the given ID
		window.location.href = `/allbusinesses/${businessId}/edit`;
	}
...
<style>
	...
	td:nth-child(3) {
		/* Tier column */
		max-width: 150px; /* Increased by 20px */
		/* white-space: nowrap; */
	...
	td:nth-child(5) {
		/* GST column */
		max-width: 80px; /* Increased by 20px */
		word-wrap: break-word;
	}
	...
	td:nth-child(8) {
		/* Tag column */
		max-width: 100px; /* Reduced by 20px */
	}
