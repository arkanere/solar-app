		...
		chart = new Chart(canvas, {
			...
			options: {
				...
				plugins: {
					...
					tooltip: {
						callbacks: {
							label: (ctx) => `${ctx.dataset.label}: ${ctx.parsed.y} businesses/day`
						}
					}
				},
				scales: {
...
<main class={darkMode ? 'dark' : 'light'}>
	<div class="header">
		...
		<h1>Businesses Onboarded Analytics</h1>
	</div>
	...
	{:else}
		<div class="stats-grid">
			<div class="stat-card">
				...
				<div class="stat-label">avg businesses / day</div>
			</div>
		...
		<div class="chart-section">
			<h3>Average Daily Businesses Onboarded - Trend (Last 3 Months)</h3>
