<script>
  ...
  $: weeklyTotal = analytics.weeklyBreakdown
    ? analytics.weeklyBreakdown.reduce((sum, week) => sum + week.count, 0)
    : 0;
</script>
...
<main class={darkMode ? "dark" : "light"}>
  ...
  {:else}
        ...
        <div class="status-grid">
          <div class="status-card tier1">
            ...
            <div class="status-number">
              {analytics.statusBreakdown.tier1_count || 0}
            </div>
          </div>
          ...
          <div class="status-card tier2">
            ...
            <div class="status-number">
              {analytics.statusBreakdown.tier2_count || 0}
            </div>
          </div>
          ...
          <div class="status-card tier3">
            ...
            <div class="status-number">
              {analytics.statusBreakdown.tier3_count || 0}
            </div>
          </div>
          ...
          <div class="status-card hidden">
            ...
            <div class="status-number">
              {analytics.statusBreakdown.hidden_count || 0}
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="breakdown-card">
              <div class="breakdown-header">
                ...
                <span class="breakdown-date"
                  >{week.weekStart} to {week.weekEnd}</span
                >
              </div>
    ...
    <div class="actions-section">
      <a href="/in/admin/allbusinesses" class="action-link"
        >View All Businesses</a
      >
      <a
        href="/in/admin/analytics/lead-generation"
        class="action-link secondary">View Lead Analytics</a
      >
    </div>
  {/if}
</main>
