...
<main class={darkMode ? 'dark' : 'light'}>
	<div class="header">
		...
		<h1>Unclaimed - No Verified Business Present</h1>
	</div>
	...
	{:else}
		...
		<div class="chart-section">
			<h3>Trend - No Verified Business in District (Last 3 Months)</h3>
...
<style>
	...
	.light .stat-card { background-color: var(--card-light-bg); border: 1px solid var(--border-light); }
	.dark .stat-card { background-color: var(--card-dark-bg); border: 1px solid var(--border-dark); }

	.stat-card:hover { transform: translateY(-2px); }

	.stat-card h2 { font-size: 1rem; margin-bottom: 1rem; opacity: 0.8; font-weight: 500; }
	.stat-number { font-size: 2.5rem; font-weight: 700; margin-bottom: 0.5rem; color: var(--accent-color); }
	.stat-label { font-size: 0.9rem; opacity: 0.7; }

	.chart-section { margin-bottom: 3rem; }
	.chart-section h3 { font-size: 1.3rem; margin-bottom: 1rem; color: var(--accent-color); }
	...
	.light .chart-container { background-color: var(--card-light-bg); border: 1px solid var(--border-light); }
	.dark .chart-container { background-color: var(--card-dark-bg); border: 1px solid var(--border-dark); }
