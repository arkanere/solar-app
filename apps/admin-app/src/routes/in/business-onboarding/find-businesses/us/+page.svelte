<script>
	...
	function applyFilters() {
		...
		window.location.href = '/in/business-onboarding/find-businesses/us' + (query ? '?' + query : '');
	}

	function clearFilters() {
		window.location.href = '/in/business-onboarding/find-businesses/us';
	}
	...
	function goToPage(p) {
		...
		if (filters.emailStatus !== 'all') params.set('email_status', filters.emailStatus);
		params.set('page', p);
		window.location.href = '/in/business-onboarding/find-businesses/us?' + params.toString();
	}
