<script>
	...
	async function triggerWelcomeMail() {
		try {
			const response = await fetch('/us/api/triggerWelcomeMail', {
				method: 'POST',
				headers: {
	...
	async function triggerPasswordReset() {
		try {
			const response = await fetch('/us/api/triggerPasswordReset', {
				method: 'POST',
				headers: {
					'Content-Type': 'application/json'
				},
...
<svelte:head>
	...
	<meta name="description" content="Admin dashboard to edit business details." />
</svelte:head>
...
<main class={darkMode ? 'dark' : 'light'}>
	...
	<form method="POST">
		...
		<div class="form-group">
			...
			<button type="button" class="secondary-button" on:click={triggerWelcomeMail}>
		...
		<div class="form-group">
			<label>Account Management</label>
			<button type="button" class="secondary-button" on:click={triggerPasswordReset}>
		...
		<div class="form-group">
			...
			<input id="address" name="address" bind:value={updatedBusiness.address} required />
		</div>

		<div class="form-group">
			<label for="pluscode">Plus Code</label>
			<input id="pluscode" name="pluscode" bind:value={updatedBusiness.pluscode} />
		</div>

		<div class="form-group">
			<label for="phonenumber">Phone Number</label>
			<input id="phonenumber" name="phonenumber" bind:value={updatedBusiness.phonenumber} />
		</div>

		<div class="form-group">
			<label for="whatsapp">WhatsApp Number</label>
			<input id="whatsapp" name="whatsapp" bind:value={updatedBusiness.whatsapp} />
		</div>

		<div class="form-group">
			<label for="email">Business Email</label>
			<input id="email" name="email" type="email" bind:value={updatedBusiness.email} />
		</div>
		...
		<div class="form-group">
			...
			<input id="instagram_id" name="instagram_id" bind:value={updatedBusiness.instagram_id} />
		</div>
		...
		<div class="form-group">
			...
			<input id="ein" name="ein" bind:value={updatedBusiness.ein} />
		</div>

		<div class="form-group">
			<label for="state">State</label>
			<input id="state" name="state" bind:value={updatedBusiness.state} required />
		</div>

		<div class="form-group">
			<label for="county">County</label>
			<input id="county" name="county" bind:value={updatedBusiness.county} required />
		</div>
		...
		<div class="form-group">
			...
			<input id="zipcode" name="zipcode" maxlength="6" bind:value={updatedBusiness.zipcode} />
		</div>
		...
		<div class="form-group">
			...
			<textarea id="notes" name="notes" bind:value={updatedBusiness.notes}></textarea>
		</div>
		...
		<div class="form-group">
			...
			<select id="isvisible" name="isvisible" bind:value={updatedBusiness.isvisible} required>
