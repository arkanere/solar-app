...
import { sendEmail } from '$lib/sendEmail.js'; // Import Brevo email utility
...
export async function POST({ request }) {
    ...
    `;
		...
		const resetLink = `https://business.solarvipani.com/us/${business_slug}/reset-password/${token}`;
			...
			<body>
				<div style="max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
					...
					<div style="margin: 20px 0;">
						<p>You requested a password reset for your Solar Vipani business account.</p>
