<script>
	...
	async function updateBlog(publishNow = false) {
		...
		try {
			...
			// Call API
			const response = await fetch('/us/api/blogs/update', {
				method: 'POST',
...
<div class="edit-blog-page" class:dark={darkMode}>
	<div class="page-header">
		...
		<button class="btn-back" on:click={() => goto('/us/blogs')}>← Back to Blogs</button>
	</div>
	...
	<form on:submit|preventDefault={() => updateBlog(false)}>
		<div class="form-grid">
			...
			<div class="main-section">
				...
				<!-- Slug -->
				<SlugInput bind:slug {title} blogId={blog.id} region="us" onChange={handleSlugChange} />
