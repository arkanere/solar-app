...
import { TokenSecurity } from '$lib/in/auth/business/TokenSecurity.js';
import { passwordResetLimiter } from '$lib/in/auth/business/RateLimiter.js';
...
export async function POST({ request, getClientAddress }) {
	...
	try {
      ...
      WHERE slug = $1;
    `;
		const result = await pool.query(query, [business_slug]);
