/**
 * India FAQ copy for the /in/solar geo pages. Ported VERBATIM from
 * apps/main-app/src/lib/countries/faq-in.ts — this is published content with
 * FAQPage structured data pointing at it, so rewording it here would make two
 * live sites answer the same question differently.
 */
