/**
 * US FAQ copy for the /us/solar geo pages. Ported VERBATIM from
 * apps/main-app/src/lib/countries/faq-us.ts — see the note in faq-in.ts.
 *
 * It mirrors faq-in's generator signatures so `faq.ts` can dispatch on country
 * without either side knowing about the other. Incentive wording is
 * deliberately non-specific: federal, state and utility programs change often
 * and vary by state.
 */
...
export function generateFAQ(city: string): FAQItem[] {
  ...
  return [
    ...
    },
    {
      ...
      answer:
        'Most US homes need a 6-8 kW system, which is roughly 15-20 panels of 400 watts each, depending on your electricity usage, roof space, and local sun hours.'
    },
    {
    ...
    },
    {
      ...
      answer:
        'Savings depend on your utility rates and net metering policy, but most homeowners offset 70-100% of their electricity bill. Over the 25+ year life of a system, that typically adds up to tens of thousands of dollars.'
    }
  ];
}
