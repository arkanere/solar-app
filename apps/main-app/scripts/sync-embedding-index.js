...
//
// Run:  node --env-file=.env.local scripts/sync-embedding-index.js
//
...
const USER_AGENT = 'A7k9X2mP4nQ8vB3r';
...
async function main() {
	...
	if (!connectionString) {
		throw new Error('POSTGRES_URL not set. Run with: node --env-file=.env.local scripts/sync-embedding-index.js');
	}
