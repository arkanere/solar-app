<script>
  ...
  function loadMoreBusinesses() {
    ...
    visibleBusinesses = [
      ...visibleBusinesses,
      ...businesses.slice(startIndex, endIndex),
    ];
          ...
          <div class="business-header">
            <h2>
              <a
                ...
                class="business-link">{business.businessname}</a
              >
            </h2>
            {#if business.tag}<span class="business-tag">{business.tag}</span
              >{/if}
          </div>
          ...
          {#if business.businessfilled}
            ...
            <div class="button-container">
              <button
                class="call-now"
                on:click={() =>
                  makeCall(business.phonenumber, business.city, business.slug)}
              >
