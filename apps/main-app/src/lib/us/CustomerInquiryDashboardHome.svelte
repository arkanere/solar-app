...
<section id="lead-data">
	...
	{:else}
						...
						<div class="lead-details">
							...
							<div class="button-container">
								...
								{:else if lead.category !== 1 && !lead.status}
									...
									<button class="delete-button" on:click={() => showDeleteConfirmation(lead)}>
										Delete Lead
									</button>
								{/if}
							</div>
				...
				{#if leads.length > 5}
					<div class="view-more">
						<p>
							...
							<a href="/business/{businessSlug}/crm">View all leads in CRM</a>
						</p>
					</div>
				{/if}
			{:else}
		...
		<div class="crm-button-container">
			<a href="/business/{businessSlug}/crm" class="open-crm-button"> Open CRM </a>
		</div>
	{/if}
</section>
