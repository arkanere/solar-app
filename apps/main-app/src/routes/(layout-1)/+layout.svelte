...
<nav class={$isDarkMode ? 'dark' : 'light'}>
	<a href="/">Solar Vipani</a>
	<a href="/business-listing">List Business</a>
	<a href="/recent-solar-installation-projects">Recent Projects</a>
	<a href="/solar-panel-installer-directory">Directory</a>
