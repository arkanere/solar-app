<script>
	...
	import BusinessDirectory from '$lib/BusinessDirectory.svelte';
...
<svelte:head>
	<title>Solar Vipani | India's #1 Solar Services Aggregator | Quickly Get Solar Quotations from 2-3 Verified Installers</title>
	<meta
		name="description"
	...
	<!-- Enhanced Open Graph -->
	<meta property="og:title" content="Solar Vipani | India's #1 Solar Panel Installer Directory" />
	<meta
	...
	<meta name="twitter:title" content="Solar Vipani | India's #1 Solar Panel Installer Directory" />
	<meta
...
<main class={darkMode ? 'dark' : 'light'}>
	...
	<div class="hero-banner">
		...
		<div class="hero-content">
			<h1>
				India's #1 Solar Panel Installation Quotation Service - 450+ Verifed Solar Panel Installers
			</h1>
			<h2>Get Started Instantly with Quotations from 2-3 Verified Solar Installers Near You</h2>
			<p>
				Quotation Service for Smart Customers. Get free quotes, compare prices, and save up to 95%
				on electricity bills with government subsidy under PM Surya Ghar Yojana.
			</p>
			<p class="hero-social-proof">
				Join 2000+ households and businesses who have started their solar installation journey with Solarvipani.com
			</p>
		...
		<section class="benefits-section">
			<div class="section-header">
				...
				<p class="section-subtitle">
					Discover the amazing benefits of switching to solar power with government support and
					verified installers
				</p>
			</div>
			...
			<div class="benefits-grid">
				...
				<div class="benefit-card highlight-card">
					...
					<p>Reduce your carbon footprint and contribute to a cleaner, greener India</p>
				</div>
			</div>
		</section>
			...
			<div class="blogs-grid">
				<div class="blog-card">
					<div class="blog-content">
						<h3>
							<a href="/blogs/hiring-verified-solar-installer-in-india-is-essential"
								>Why Hiring a Verified Solar Installer in India Is Essential</a
							>
						</h3>
						<p>
							Learn about the importance of professional workmanship, safety compliance, maximizing
							system efficiency, and ensuring long-term support.
						</p>
						<a href="/blogs/hiring-verified-solar-installer-in-india-is-essential" class="read-more"
							>Read More →</a
						>
					</div>
				</div>
				...
				<div class="blog-card">
					<div class="blog-content">
						<h3>
							<a href="/blogs/pm-surya-ghar-yojana"
								>PM Surya Ghar Yojana: Your Guide to Check Eligibility</a
							>
						</h3>
						<p>
							Understand the eligibility criteria and steps to benefit from the government scheme
							providing subsidies for solar rooftop installations.
						</p>
						<a href="/blogs/pm-surya-ghar-yojana" class="read-more">Read More →</a>
					</div>
				</div>
				...
				<div class="blog-card">
					<div class="blog-content">
						<h3>
							<a href="/blogs/cost-of-solar-on-grid-system"
								>What is the Approximate Cost of a Solar On Grid System?</a
							>
						</h3>
						<p>
							Learn about the costs associated with installing a solar on-grid system, including
							equipment, labor, and other components.
						</p>
						<a href="/blogs/cost-of-solar-on-grid-system" class="read-more">Read More →</a>
					</div>
				</div>
			</div>

			<div class="blogs-cta">
				<a href="/blogs" class="view-all-blogs">View All Blogs</a>
			</div>
		</section>
