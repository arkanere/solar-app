<script>
  import BusinessForm from "$lib/in/BusinessForm.svelte";
  import { isDarkMode } from "$lib/in/themeStore"; // Import dark mode state
...
<svelte:head>
  ...
  <title>Business Form | Solar Vipani</title>
  <meta
    name="description"
...
<style>
  ...
  /* Business info section styling (without box effect) */
</style>
