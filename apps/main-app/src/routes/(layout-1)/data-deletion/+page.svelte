...
<main class="min-h-screen p-8 transition-colors duration-100 bg-[hsl(var(--background))] text-[var(--color-text-primary)] dark:bg-[hsl(var(--background))]">
  <div class="max-w-2xl mx-auto">
    ...
    <div class="mb-8">
      ...
      <div class="p-6 bg-[hsl(var(--muted))] rounded-lg mb-8 shadow-card dark:bg-[hsl(var(--muted))]">
    ...
    {:else}
      <form onsubmit={handleSubmit} class="p-8 bg-[hsl(var(--card))] rounded-lg shadow-card mb-8 dark:bg-[hsl(var(--card))]">
        <div class="mb-6">
          ...
          <input
            ...
            class="w-full px-3 py-2 border border-[hsl(var(--border))] rounded transition-colors duration-100 focus:outline-none focus:border-[hsl(var(--accent))] dark:bg-[hsl(var(--background-secondary))] dark:border-[hsl(var(--border))] dark:text-[var(--color-text-primary)]"
          />
        </div>
        ...
        <div class="mb-6">
          ...
          <textarea
            ...
            rows="4"
            class="w-full px-3 py-2 border border-[hsl(var(--border))] rounded transition-colors duration-100 focus:outline-none focus:border-[hsl(var(--accent))] resize-vertical min-h-24 dark:bg-[hsl(var(--background-secondary))] dark:border-[hsl(var(--border))] dark:text-[var(--color-text-primary)]"
          ></textarea>
        </div>
        ...
        <button
          type="submit"
          disabled={submitting}
          class="w-full py-2 px-8 bg-[hsl(var(--accent))] text-[var(--color-text-primary)] rounded font-semibold transition-all duration-100 cursor-pointer hover:opacity-90 disabled:opacity-60 disabled:cursor-not-allowed"
        >
    ...
    <div class="p-6 bg-[hsl(var(--muted))] rounded-lg shadow-card dark:bg-[hsl(var(--muted))]">
