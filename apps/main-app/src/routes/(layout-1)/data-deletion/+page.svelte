...
<main class={darkMode ? 'dark' : 'light'}>
	<div class="container">
		...
		<div class="intro-section">
			<p>
				We respect your privacy and your right to control your personal data. Whether you are a customer or a registered solar installer on our platform, if you would like to request deletion of your personal information from our database, please fill out the form below.
			</p>
		...
		{#if submitted}
			<div class="success-message">
				...
				<p>
					Your data deletion request has been received. We will process your request within 30 days and send you a confirmation email once completed.
				</p>
				<p>
					If you have any questions, please contact us at <a href="mailto:admin@solarvipani.com">admin@solarvipani.com</a>.
				</p>
			</div>
		{:else}
		...
		<div class="additional-info">
			...
			<ul>
				...
				<li>Some data may be retained for legal compliance purposes (financial records, tax documentation, government subsidy records)</li>
				<li>Deleting your data will remove you from our marketing communications</li>
				<li><strong>For Installers:</strong> Your business will be removed from our directory and you will no longer receive leads</li>
				<li><strong>For Customers:</strong> You will no longer receive solar installation quotes or updates</li>
			</ul>
