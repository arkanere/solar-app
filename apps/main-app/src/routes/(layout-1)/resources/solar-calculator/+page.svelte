<script>
	...
	let currentBill = 1000; // Initial value for current electricity bill in Rupees
...
<main class={darkMode ? 'dark' : 'light'}>
	<div class="solar-calculator">
		...
		<p>
			Calculate the size of the solar system required based on your current electricity consumption.
		</p>
		...
		<div class="slider-group">
			<div class="slider-label">
				<label for="ratePerUnit">Electricity Rate per Unit (in Rupees/unit):</label>
