<script lang="ts">
	...
	const breadcrumb = $derived(breadcrumbLD([
		...
		{ name: 'Solar Installation', url: 'https://solarvipani.com/solar-installation' }
	]));
...
<svelte:head>
	...
	<link rel="canonical" href="https://solarvipani.com/solar-installation" />
...
<PillarPage
	...
	stats={data.stats}
	siblingPillars={[
		{ name: 'Rooftop Solar Guide', href: contentUrl('/rooftop-solar/') }
	]}
/>
