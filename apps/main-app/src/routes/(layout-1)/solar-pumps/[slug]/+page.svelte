<script lang="ts">
	...
	const breadcrumb = $derived(breadcrumbLD([
		...
		{ name: 'Solar Pumps', url: 'https://solarvipani.com/solar-pumps' },
		{
			...
			url: `https://solarvipani.com/solar-pumps/${isCluster ? d.clusterData.slug : d.brand.slug}`
		}
	]));
...
<svelte:head>
	...
	<link rel="canonical" href="https://solarvipani.com/solar-pumps/{canonicalSlug}" />
