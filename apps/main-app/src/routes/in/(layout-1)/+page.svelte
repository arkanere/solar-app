...
<main class="w-full bg-background text-foreground transition-colors duration-300 overflow-x-hidden dark:bg-background dark:text-foreground">
  ...
  <div class="relative w-full h-[theme(--height-md)] flex items-center justify-center text-center overflow-hidden md:h-[theme(--height-xl)]">
    ...
    <div class="absolute top-0 left-0 w-full h-full z-10" style="background: var(--gradient-overlay-primary);"></div>
    <div class="relative z-20 max-w-3xl px-6">
      ...
      <div class="flex justify-center gap-[theme(--card-gap)] flex-wrap mt-[theme(--spacing-2xl)]">
        <span class="bg-white/15 px-[theme(--badge-padding-x)] py-[theme(--badge-padding-y)] rounded-[theme(--badge-radius)] text-primary-foreground text-[theme(--badge-font-size)] md:text-base font-[theme(--badge-font-weight)] backdrop-blur border border-white/20">✓ 450+ Pre-Vetted Installers</span>
        <span class="bg-white/15 px-[theme(--badge-padding-x)] py-[theme(--badge-padding-y)] rounded-[theme(--badge-radius)] text-primary-foreground text-[theme(--badge-font-size)] md:text-base font-[theme(--badge-font-weight)] backdrop-blur border border-white/20">✓ Zero Cost Consultation</span>
        <span class="bg-white/15 px-[theme(--badge-padding-x)] py-[theme(--badge-padding-y)] rounded-[theme(--badge-radius)] text-primary-foreground text-[theme(--badge-font-size)] md:text-base font-[theme(--badge-font-weight)] backdrop-blur border border-white/20">✓ Full Subsidy Guidance</span>
      </div>
    </div>
  </div>
  ...
  <div class="mx-auto max-w-[1140px] p-[theme(--container-padding)]">
    ...
    <section class="mb-8 rounded-[theme(--radius-lg)] bg-card p-[theme(--card-padding-y)] shadow-[theme(--shadow-md)]">
      ...
      <div class="grid grid-cols-1 md:grid-cols-5 gap-[theme(--card-gap)]">
        ...
        <div class="text-center border border-border hover:shadow-[theme(--shadow-card-hover)] hover:-translate-y-[theme(--hover-lift-sm)] rounded-[theme(--radius-lg)] bg-background p-[theme(--spacing-2xl)] transition-all duration-[theme(--transition-default)]">
          ...
          <h3 class="text-lg font-semibold text-primary mb-[theme(--spacing-md)]">Connect with Experts</h3>
          <p class="text-foreground dark:text-foreground-secondary">
        ...
        <div class="text-center border border-border hover:shadow-[theme(--shadow-card-hover)] hover:-translate-y-[theme(--hover-lift-sm)] rounded-[theme(--radius-lg)] bg-background p-[theme(--spacing-2xl)] transition-all duration-[theme(--transition-default)]">
          <div class="w-12 h-12 bg-primary text-primary-foreground rounded-full flex items-center justify-center font-bold text-xl mx-auto mb-[theme(--spacing-lg)]">5</div>
    ...
    <section id="lead-form-sv" class="mb-8">
      <div class="rounded-[theme(--radius-lg)] p-[theme(--card-padding-y)] shadow-[theme(--shadow-lg)] bg-gradient-to-br from-primary/10 to-primary/5">
        <div class="text-center mb-[theme(--spacing-2xl)]">
          <h2 class="text-3xl md:text-4xl font-semibold mb-[theme(--spacing-lg)] text-primary">Book A Free Consultation</h2>
          <div class="flex justify-center items-center my-[theme(--spacing-lg)]">
            <span class="w-[theme(--divider-line-width)] h-[theme(--divider-line-height)] bg-accent rounded"></span>
          </div>
