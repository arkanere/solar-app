...
<main class="w-full bg-background text-foreground transition-colors duration-100 overflow-x-hidden dark:bg-background dark:text-foreground">
  ...
  <div class="mx-auto max-w-[1140px] p-[theme(--container-padding)]">
    ...
    <section id="lead-form-sv" class="mb-8 mx-auto max-w-[theme(--max-width-md)]">
      <div class="rounded-[theme(--radius-lg)] p-[theme(--card-padding-y)] shadow-card bg-gradient-to-br from-primary/10 to-primary/5">
    ...
    <section class="mb-8 rounded-[theme(--radius-lg)] bg-card p-[theme(--card-padding-y)] shadow-card">
      <div class="text-center mb-[theme(--spacing-2xl)]">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-[theme(--card-gap)]">
        <div class="text-center bg-background-secondary hover:shadow-card hover:-translate-y-[theme(--hover-lift-sm)] rounded-[theme(--radius-lg)] p-[theme(--spacing-2xl)] transition-all duration-[theme(--transition-default)]">
        ...
        <div class="text-center bg-background-secondary hover:shadow-card hover:-translate-y-[theme(--hover-lift-sm)] rounded-[theme(--radius-lg)] p-[theme(--spacing-2xl)] transition-all duration-[theme(--transition-default)]">
          ...
          <h3 class="text-lg font-semibold mb-[theme(--spacing-lg)]">Share Your Success</h3>
          <p class="text-foreground dark:text-foreground-secondary">
    ...
    <section class="mb-8 rounded-[theme(--radius-lg)] p-[theme(--card-padding-y)] shadow-card bg-background-secondary">
      <div class="text-center mb-[theme(--spacing-2xl)]">
    ...
    <!-- Benefits Section -->
    <section class="mb-8 rounded-[theme(--radius-lg)] bg-background-secondary p-[theme(--card-padding-y)] shadow-card">
      <div class="text-center mb-[theme(--spacing-2xl)]">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-[theme(--card-gap)] mb-[theme(--spacing-2xl)]">
        <div class="flex flex-col items-center text-center border-t-[theme(--card-accent-border)] hover:shadow-card hover:-translate-y-[theme(--hover-lift-md)] rounded-[theme(--radius-lg)] bg-card p-[theme(--card-padding-y)] shadow-card transition-all duration-[theme(--transition-default)]">
    ...
    <section class="mb-8 rounded-[theme(--radius-lg)] bg-card p-[theme(--card-padding-y)] shadow-card">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-[theme(--card-gap)] mb-[theme(--spacing-2xl)]">
        <div class="bg-background-secondary flex flex-col hover:shadow-card hover:-translate-y-[theme(--hover-lift-sm)] rounded-[theme(--radius-lg)] p-[theme(--spacing-2xl)] transition-all duration-[theme(--transition-default)]">
