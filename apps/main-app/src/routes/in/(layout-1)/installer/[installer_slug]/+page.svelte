<script lang="ts">
	...
	const breadcrumb = $derived(
		breadcrumbLD([
			...
			{ name: b.businessname, url: `https://solarvipani.com/in/installer/${b.slug}/` }
		])
	);
...
<div class="max-w-4xl mx-auto px-4 py-8">
		...
		<section class="mb-8">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
				{#each projects as project (project.id)}
					<a href="/in/project/{project.project_slug}/" rel="noopener" class="group">
	...
	{#if stateSlug && districtSlug}
		<div class="mt-8">
			<a href="/in/solar/{stateSlug}/{districtSlug}/" class="text-primary hover:underline text-sm">
