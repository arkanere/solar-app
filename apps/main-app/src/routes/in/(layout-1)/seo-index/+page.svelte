			...
			pillars: [
				...
				},
				{
					...
					clusters: [
						...
						{ label: 'Roof Assessment', href: '/in/solar-installation/roof-assessment' },
						{ label: 'Permits', href: '/in/solar-installation/permits' },
						{ label: 'Grid Connection', href: '/in/solar-installation/grid-connection' },
						{ label: 'Safety', href: '/in/solar-installation/safety' },
						{ label: 'DIY vs Professional', href: '/in/solar-installation/diy-vs-professional' },
						{ label: 'Site Survey', href: '/in/solar-installation/site-survey' },
						{ label: 'Wiring', href: '/in/solar-installation/wiring' },
						{ label: 'Commissioning', href: '/in/solar-installation/commissioning' }
					]
				},
				{
