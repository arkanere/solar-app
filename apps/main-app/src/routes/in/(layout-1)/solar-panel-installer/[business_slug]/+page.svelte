<script>
	...
	const navigateToDirectory = () =>
		business?.city && goto(`/solar-panel-installer-directory/${encodeURIComponent(business.city)}`);
									...
									<div class="detail-item">
										...
										<div class="detail-content">
											...
											<a
												...
												target="_blank"
												rel="noopener noreferrer"
												class="detail-value instagram-link">{business.instagram_id}</a
											>
										</div>
									</div>
								{/if}
					...
					<div class="projects-grid">
						{#each projects as project (project.id)}
							<div class="project-card">
								<a
									href="/solar-panel-installer/{businessSlug}/project/{project.project_slug}"
									class="project-link"
								>
