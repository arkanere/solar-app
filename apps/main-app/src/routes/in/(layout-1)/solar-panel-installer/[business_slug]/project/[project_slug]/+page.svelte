...
<main class="w-full font-sans leading-relaxed overflow-x-hidden flex flex-col items-center px-2 py-4 min-h-screen bg-background text-foreground transition-colors duration-300">
  <!-- Breadcrumb Navigation -->
  <nav class="w-full max-w-[1140px] mb-6 text-sm flex items-center flex-wrap gap-2 bg-card px-[theme(--container-padding)] py-3 rounded-[theme(--radius-lg)] shadow-[theme(--shadow-sm)] transition-colors duration-300">
  ...
  <!-- Project Header -->
  <header class="w-full max-w-[1140px] text-center py-12 px-[theme(--container-padding)] bg-primary rounded-[theme(--radius-xl)] text-primary-foreground mb-6 relative overflow-hidden">
    <h1 class="text-4xl font-bold m-0 mb-3 leading-tight relative z-10">{project.title}</h1>
    <p class="text-lg m-0 text-primary-foreground/90 mb-3 relative z-10">
    ...
    <div class="flex flex-wrap justify-center items-center gap-4 text-sm text-primary-foreground/80 relative z-10">
      {#if project.pincode}
  ...
  <!-- Project Image -->
  <section class="w-full max-w-[1140px] flex justify-center mb-12 bg-card px-[theme(--container-padding)] py-[theme(--container-padding)] rounded-[theme(--radius-xl)] shadow-[theme(--shadow-md)]">
    {#if project.cloudinary_public_id}
      <img
...
<!-- View Installer Profile Section -->
  <section class="w-full max-w-[1140px] mb-6 rounded-[theme(--radius-lg)] bg-[hsl(var(--accent)/0.1)] p-[theme(--card-padding-y)] shadow-[theme(--shadow-md)] transition-all">
    <div class="text-center">
      <h2 class="text-2xl md:text-3xl font-semibold mb-4 text-primary">Interested in This Installer?</h2>
