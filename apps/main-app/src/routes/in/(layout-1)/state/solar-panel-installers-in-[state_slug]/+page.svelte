...
<svelte:head>
	<title>Solar Panel Installers in {state} - Find installers by district - Solar Vipani</title>
	<meta
		name="description"
				...
				<li>
					<div class="district-card">
						...
						<div class="card-actions">
							<a
								href={`/solar-panel-installer-directory/${formatDistrictSlug(district)}`}
								rel="noopener"
							...
							<a
								href={`/district/${formatDistrictSlug(district)}`}
								rel="noopener"
