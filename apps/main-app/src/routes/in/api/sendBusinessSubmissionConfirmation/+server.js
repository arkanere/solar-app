// src/routes/api/sendBusinessSubmissionConfirmation/+server.js
...
export async function POST({ request }) {
	try {
		...
		const subject = `Business Details Received For Listing - Solar Vipani`;

		const message = `
            <p>Dear ${businessName} Team,</p>
            <p>Thank you for submitting your business details with Solar Vipani for business listing!</p> 
            ...
            <ul>
                ...
                <li><strong>GSTN:</strong> ${gstn || 'Not provided'}</li>
            </ul>
            <p>Our team will review your business details shortly. Once verified, your business will be visible on our platform.</p>
            <p>After verification, You will receive login credentials to manage your business profile on email.</p>
            ...
            <p>Thank you for choosing Solar Vipani. We look forward to a successful partnership!</p>
