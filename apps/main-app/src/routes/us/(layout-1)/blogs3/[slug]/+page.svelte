...
<main class={darkMode ? 'dark' : 'light'}>
	<div class="blogpost">
		<header class="blog-header">
			<h1>{blog.title}</h1>
			{#if blog.author_name}
				<p>By <a href="/us/about-us">{blog.author_name}</a></p>
			{/if}
	...
	<section id="lead-form-sv" class="lead-form-section">
		...
		<p class="lead-form-subtitle">
			Connect with verified solar installers in your area and receive personalized quotes. Free
			consultation and competitive pricing guaranteed.
		</p>
		<LeadFormBusiness />
	</section>
</main>
