...
<main class="flex flex-col items-center px-[theme(--container-padding)] md:px-[theme(--container-padding)] py-8 transition-colors duration-300 bg-background text-foreground">
	<div class="max-w-3xl w-full">
		...
		<section class="mb-8">
			...
			<p class="text-base md:text-lg leading-relaxed text-foreground-secondary">
				<strong class="text-foreground">Request Data Deletion:</strong> You can request deletion of your personal data by visiting our
				<a href="/data-deletion" class="text-primary underline hover:no-underline">Data Deletion Request page</a>. We will process your request within 30 business days.
			</p>
		</section>
