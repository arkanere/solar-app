// src/routes/api/us/sendLeadSubmissionConfirmation/+server.js
import { json } from '@sveltejs/kit';
import { sendEmail } from '$lib/us/sendEmail'; // Utility for sending emails

export async function POST({ request }) {
	try {
		const { id, name, phone, zipCode, type, comment, urlParam, email } = await request.json();
