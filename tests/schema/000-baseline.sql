...
CREATE TABLE "leaddata" (
	...
	"email_invite_count" smallint DEFAULT 0,
...
CREATE TABLE "us_branches" (
	"id" integer PRIMARY KEY DEFAULT nextval('branches_id_seq'::regclass) NOT NULL,
	"main_id" integer NOT NULL,
	"branch_id" integer NOT NULL,
	"isactive" boolean DEFAULT true,
	"created_at" timestamp DEFAULT now()
...
CREATE TABLE "us_leaddata" (
	"id" integer PRIMARY KEY DEFAULT nextval('leaddata_id_seq'::regclass) NOT NULL,
	"name" varchar(255) NOT NULL,
	"phone" varchar(16) NOT NULL,
	...
	"sv_comment_for_businesses" text,
	"marketing_consent" boolean DEFAULT false NOT NULL,
	CONSTRAINT "check_claim_count_limit_us" CHECK ((claim_count >= 0) AND (claim_count <= 5))
);

CREATE TABLE "us_leaddata_claimrequests" (
	"id" integer PRIMARY KEY DEFAULT nextval('leaddata_claimrequests_id_seq'::regclass) NOT NULL,
	"lead_id" integer DEFAULT nextval('leaddata_claimrequests_lead_id_seq'::regclass) NOT NULL,
	"claim_id" integer DEFAULT nextval('leaddata_claimrequests_claim_id_seq'::regclass) NOT NULL,
	"business_id" smallint,
	"isallotted" boolean DEFAULT false,
	"isresolved" boolean DEFAULT false,
	"created_at" timestamp DEFAULT now(),
	CONSTRAINT "unique_lead_business_claim_us" UNIQUE("lead_id","business_id")
);

CREATE TABLE "us_locations" (
	"id" integer PRIMARY KEY DEFAULT nextval('locations_id_seq'::regclass) NOT NULL,
	"state" varchar(255),
	"county" varchar(255),
	"city" varchar(255),
	"source" smallint,
...
CREATE TABLE "us_projects" (
	"id" integer PRIMARY KEY DEFAULT nextval('projects_id_seq'::regclass) NOT NULL,
	"title" varchar(255) NOT NULL,
...
CREATE INDEX "us_businesses_city_idx" ON "us_businesses" USING btree ("city");
CREATE INDEX "us_businesses_slug_idx" ON "us_businesses" USING btree ("slug");
